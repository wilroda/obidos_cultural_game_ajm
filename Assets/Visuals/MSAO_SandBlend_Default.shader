...
Shader "MSAO_Sand_Default"
{
	Properties
	{
		...
		_SandOffset("SandOffset", Float) = 1
		_SandStrength("SandStrength", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar16 = TriplanarSampling16( _TopTexture0, WorldPosition, WorldNormal, 1.0, float2( 1,1 ), 1.0, 0 );
				float2 uv_Albedo = IN.ase_texcoord8.xy * _Albedo_ST.xy + _Albedo_ST.zw;
				float clampResult18 = clamp( WorldPosition.y , 0.0 , _SandOffset );
				float4 lerpResult19 = lerp( triplanar16 , tex2D( _Albedo, uv_Albedo ) , saturate( ( clampResult18 * _SandStrength ) ));
				
				float2 uv_Normal = IN.ase_texcoord8.xy * _Normal_ST.xy + _Normal_ST.zw;
				
				float2 uv_RMHA = IN.ase_texcoord8.xy * _RMHA_ST.xy + _RMHA_ST.zw;
				float4 tex2DNode10 = tex2D( _RMHA, uv_RMHA );
				...
				float Smoothness = ( ( 1.0 - tex2DNode10.r ) * _Roughness );
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar16 = TriplanarSampling16( _TopTexture0, WorldPosition, ase_worldNormal, 1.0, float2( 1,1 ), 1.0, 0 );
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.SamplerNode;10;-574.1009,438.4858;Inherit;True;Property;_RMHA;RMHA;2;0;Create;True;0;0;0;False;0;False;-1;134fc7f69a5a52141abee0528cba8395;134fc7f69a5a52141abee0528cba8395;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;12;-592.301,-94.01421;Inherit;True;Property;_Albedo;Albedo;1;0;Create;True;0;0;0;False;0;False;-1;None;cdaf89aee31d0454c88e4f9489bc0eab;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-580.601,140.7858;Inherit;True;Property;_Normal;Normal;3;0;Create;True;0;0;0;False;0;False;-1;None;00bf7b7d26a6f974ebdfb60d79d78f12;True;0;True;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-165.6019,458.0112;Inherit;False;Property;_Roughness;Roughness;4;0;Create;True;0;0;0;False;0;False;0;0.18;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;13;-232.5395,210.872;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;81.39807,278.6111;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;16;-303.3322,-396.8018;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;0;Assets/Visuals/sand/smooth+sand+dunes-1024x1024.png;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldPosInputsNode;17;-304.6371,-209.9697;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;20;-221.3692,-10.95728;Inherit;False;Property;_SandOffset;SandOffset;5;0;Create;True;0;0;0;False;0;False;1;3.71;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-225.7855,62.07046;Inherit;False;Property;_SandStrength;SandStrength;6;0;Create;True;0;0;0;False;0;False;1;9.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;19;583.311,-385.1706;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;18;179.3628,-187.9697;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;308.6867,-190.0537;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;23;434.657,-232.1234;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=C61748E7D3BC3B0E6F9D0FB1F6BBC56BD8984A2E